...
The measurement pipeline lives in a private repository while data
licensing questions are settled.
...
Environment Agency LiDAR (OGL v3), OS Terrain 50 / Open Names /
Open Roads (OGL v3), and OpenStreetMap (ODbL). The site's dataset CSV
is downloadable from [howsteep.org](https://howsteep.org); its licence
is under consideration — ask if you want to use it in the meantime.
